...
$banner = isset($_SESSION['banner']) ? $_SESSION['banner'] : '';
...
$embed = isset($_SESSION['embed']) ? $_SESSION['embed'] : '';
$locker = isset($_SESSION['locked']) ? $_SESSION['locked'] : '';
...
//require_once('authany/library/AuthAny/Config/AuthAny.php');
