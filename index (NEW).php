                                                        ...
                                                        <div class="panel-group" id="accordion">
                                                            ...
                                                            <div class="panel panel-success">
                                                                ...
                                                                <div id="collapse2" class="panel-collapse collapse in">
                                                                    <div class="panel-body">
                                                                        By selling campaign codes to clients (these are like coupon codes), a client simply purchase one from you that lasts up to 2 weeks and enter it on the platform to upgrade to Social Suite Pro so they can use our marketing tools for their business.
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="panel panel-success">
                                                        ...
                                                        <div class="col-sm-4 text-center">
                                                            <div class="select-options">
                                                                <div class="select-items">
                                                                    ...
                                                                    <h3>1. Get campaign codes</h3>
                                                                    <p>Share and get free campaign codes to resell. Clients enter your campaign code on our platform to upgrade their account for 2 weeks (worth £150)</p>
                                                                </div>
                                                        ...
                                                        <div class="col-sm-4 text-center">
                                                            <div class="select-options">
                                                                <div class="select-items">
                                                                    ...
                                                                    <p>Once you get your campaign codes, use our generator to create your payment link (e.g. PayPal) and landing page for clients to visit and pay you.</p>
                                                                </div>
                                                                <a href="#Login" data-toggle="modal" class="btn btn-gray btn-block"> LOGIN NOW <i class="fa fa-arrow-right"></i></a>
                                                            </div>
                                                        </div>			
                                                        ...
                                                        <div class="col-sm-4 text-center">
                                                            <div class="select-options">
                                                                <div class="select-items">
                                                                    ...
                                                                    <p>Use our Social Search tool to find millions of local businesses with their email, telephone and messenger link so you can contact them directly.</p>
                                                                </div>
                                                                <a href="#Login" data-toggle="modal" class="btn btn-gray btn-block"> LOGIN NOW <i class="fa fa-arrow-right"></i></a>
                                                            </div>
                                                        </div>	
...
//End of storing json
                        ...
                        <?php if (AUTHANY_DEBUG): ?>
            	                       		<div class="row" style="margin-top: 10px; margin-bottom: 10px;">
            	                       			<div class="col">
            	                       				<textarea rows="40" style="width: 100%;">$_SESSION  <?php
