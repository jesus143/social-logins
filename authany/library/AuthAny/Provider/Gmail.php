 ...
 * @license     Commercial
 *
 * @since  	    Monday, June 23, 2014, 09:16 PM GMT+1
 * @modified    $Date: 2014-06-24 10:19:35 +0200 (Tue, 24 Jun 2014) $ $Author: dev@cloneui.com $
 * @version     $Id: Gmail.php 13 2014-06-24 08:19:35Z dev@cloneui.com $
 *
 * @category    External Authenticaton
 * @package     AuthAny
*/

class AuthAny_Provider_Gmail extends AuthAny
{
	private $_apiConfig;
	private $_envConfig;
	private $_provider;
	...
	*/
	public function loginLocal( $data = array() )
	{
		if( !empty( $data ) ) {
			...
			$_SESSION['network']['display_name']	= 'Gmail';
			// set network's short ID
			$_SESSION['network']['short_id']		= 'gmail';
