 ...
 *
 * @since  	    Sunday, June 22, 2014, 04:25 PM GMT+1
 * @modified    $Date: 2014-06-24 10:19:35 +0200 (Tue, 24 Jun 2014) $ $Author: dev@cloneui.com $
 * @version     $Id: Soundcloud.php 13 2014-06-24 08:19:35Z dev@cloneui.com $
 *
 * @category    External Authenticaton
 * @package     AuthAny
*/

class AuthAny_Provider_Soundcloud extends AuthAny
{
	private $_apiConfig;
	private $_envConfig;
	private $_provider;
	...
	*/	
	...
	{
		$apiEndpoint = $this->_apiConfig->apiEndpoint.'/me.json?oauth_token='.$accessToken;
