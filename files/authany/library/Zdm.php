...
class Zdm {
	...
	protected $_config = array(
		'libraryPath' => '/', // If not passed will be set relative to Zdm class
		'prependStack' => true, // Prepend autoloader to autoload stack (otherwise append)
		'zfVersion' => '', // Zend Framework version
		//'repository' => 'http://framework.zend.com/svn/framework/standard/tags/release-'
		'repository' => 'https://raw.githubusercontent.com/zendframework/zf1/master'
	);
